...
ESP8266_Midea_RS485Class::ESP8266_Midea_RS485Class(HardwareSerial *hwSerial, uint8_t re_de_pin, uint8_t master_id, uint8_t slave_id, uint8_t command_time, uint8_t response_timeout) : ComControlPin(re_de_pin),
                                                                                                                                                                                       SerialBus(hwSerial),
                                                                                                                                                                                       SlaveId(slave_id),
                                                                                                                                                                                       MasterId(master_id),
...
void ESP8266_Midea_RS485Class::begin(HardwareSerial *hwSerial, uint8_t re_de_pin, uint8_t master_id, uint8_t slave_id, uint8_t command_time, uint8_t response_timeout)
{
  ComControlPin = re_de_pin;
  SerialBus = hwSerial;
  pinMode(ComControlPin, OUTPUT);
  digitalWrite(ComControlPin, RS485_RX_PIN_VALUE);
  SerialBus->begin(MIDEA_BAUDRATE);
  SlaveId = slave_id;
  MasterId = master_id;
  Master_Send_Time = command_time;
  Slave_Resp_Time = response_timeout;
...
uint8_t ESP8266_Midea_RS485Class::SetFanMode(MideaACFanModeType mode)
{
...
uint8_t ESP8266_Midea_RS485Class::SetTemp(uint8_t temp)
{
...
uint8_t ESP8266_Midea_RS485Class::SetAuxHeat_Turbo(MideaACOpFeatureStateType value)
{
  DesiredState.AuxHeat_Turbo = value;
  UpdateNextCycle = 1;
  return 1;
}
uint8_t ESP8266_Midea_RS485Class::SetEcho_Sleep(MideaACOpFeatureStateType value)
{
  DesiredState.Echo_Sleep = value;
  UpdateNextCycle = 1;
  return 1;
}
uint8_t ESP8266_Midea_RS485Class::SetSwing(MideaACOpFeatureStateType value)
{
  DesiredState.Swing = value;
  UpdateNextCycle = 1;
  return 1;
}
uint8_t ESP8266_Midea_RS485Class::SetVent(MideaACOpFeatureStateType value)
{
...
void ESP8266_Midea_RS485Class::Update()
{
  ...
  else
  {
    ...
    {
    case MIDEA_AC_OPMODE_OFF:
      SentData[6] = OP_MODE_OFF;
      break;
    case MIDEA_AC_OPMODE_AUTO:
      SentData[6] = OP_MODE_AUTO;
      break;
    case MIDEA_AC_OPMODE_FAN:
      SentData[6] = OP_MODE_FAN;
      break;
    case MIDEA_AC_OPMODE_DRY:
      SentData[6] = OP_MODE_DRY;
      break;
    case MIDEA_AC_OPMODE_HEAT:
      SentData[6] = OP_MODE_HEAT;
      break;
    case MIDEA_AC_OPMODE_COOL:
      SentData[6] = OP_MODE_COOL;
      break;
    default:
      SentData[6] = OP_MODE_OFF;
    }
    ...
    {
    case MIDEA_AC_FANMODE_AUTO:
      SentData[7] = FAN_MODE_AUTO;
      break;
    case MIDEA_AC_FANMODE_HIGH:
      SentData[7] = FAN_MODE_HIGH;
      break;
    case MIDEA_AC_FANMODE_MEDIUM:
      SentData[7] = FAN_MODE_MEDIUM;
      break;
    case MIDEA_AC_FANMODE_LOW:
      SentData[7] = FAN_MODE_LOW;
      break;
    default:
      SentData[7] = FAN_MODE_AUTO;
    }
...
void ESP8266_Midea_RS485Class::Lock()
{
  uint8_t i, resp;
...
void ESP8266_Midea_RS485Class::Unlock()
{
  uint8_t i, resp;
...
uint8_t ESP8266_Midea_RS485Class::CalculateCRC(uint8_t len)
{
  uint8_t i = 0;
  uint32_t crc = 0;
  for (i = 0; i < len; i++)
...
uint8_t ESP8266_Midea_RS485Class::ParseResponse()
{
      ...
      (ReceivedData[0x1E] == CalculateCRC(RECEIVE_CRC)))
  {
    ...
    {
    case OP_MODE_OFF:
      State.OpMode = MIDEA_AC_OPMODE_OFF;
      break;
    case OP_MODE_AUTO:
      State.OpMode = MIDEA_AC_OPMODE_AUTO;
      break;
    case OP_MODE_FAN:
      State.OpMode = MIDEA_AC_OPMODE_FAN;
      break;
    case OP_MODE_DRY:
      State.OpMode = MIDEA_AC_OPMODE_DRY;
      break;
    case OP_MODE_HEAT:
      State.OpMode = MIDEA_AC_OPMODE_HEAT;
      break;
    case OP_MODE_COOL:
      State.OpMode = MIDEA_AC_OPMODE_COOL;
      break;
    default:
      State.OpMode = MIDEA_AC_OPMODE_UNKOWN;
    }
...
uint8_t ESP8266_Midea_RS485Class::CalculateSetTime(uint32_t time)
{
...
uint32_t ESP8266_Midea_RS485Class::CalculateGetTime(uint8_t time)
{
...
ESP8266_Midea_RS485Class ESP8266_Midea_RS485(DEFAULT_SERIAL_COM_BUS, DEFAULT_SERIAL_COM_CONTROL_PIN, DEFAULT_SERIAL_COM_MASTER_ID, DEFAULT_SERIAL_COM_SLAVE_ID, DEFAULT_SERIAL_COM_MASTER_SEND_TIME, DEFAULT_SERIAL_COM_SLAVE_TIMEOUT_TIME);